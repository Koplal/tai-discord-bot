...
echo ""
echo "  2. Add these variables (LINEAR_TEAM_ID is auto-synced from the"
echo "     GitHub 'LINEAR_TEAM_ID' secret on each deploy — set it here only"
echo "     for the first boot before CI runs):"
echo "     DISCORD_BOT_TOKEN=..."
echo "     DISCORD_CLIENT_ID=..."
echo "     DISCORD_GUILD_ID=..."
echo "     ANTHROPIC_API_KEY=..."
echo "     LINEAR_API_KEY=..."
echo "     LINEAR_TEAM_ID=f7bbac54-652e-4f25-8480-74c3af77f4e8   # TAI team"
echo ""
